...
const interactions = {
    ...
    addListenerToActions: () => {
        ...
        const choiceCurrencie = document.getElementById('base_currency');                // S"lection de la div à écouter
        choiceCurrencie.addEventListener('change', app.history);                         // Déclenchement d'une fonction à la séelction
    }
